<?php
    function HTMLForm($CFG, $user_code, $user_name, $job_no, $cus_code, $fg_code, $descriptions, $moq, $plan_qty, $remarks){
        $dest = $CFG->path_main . '/' . $CFG->planning_authorize . '/ini_approve_plan';
        // $dest = 'https://kb.albatrosslogistic.com/mrp-dev/modules/planning/authorize/ini_approve_plan';
        // $user_code = 'TTV02734';
        // $user_name = 'Wiwat';
        // $job_no = 'TEST';
        // $fg_code = 'FG TEST';
        // $descriptions = 'DESCRIPTIONTEST';
        // $moq = 20;
        // $plan_qty = 30;
        // $remarks = 'wiwat test';
        // $cus_code = 'BEARJAI0';
                                    ...
                                    <tr>
                                        ...
                                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                    <div style="font-family:Inter, Helvetica, sans-serif;font-size:32px;font-weight:600;line-height:140%;text-align:left;color:#000000;">Approval of plans below the MOQ.</div>
                                                </td>
                                                </tr>
                                            </tbody>
                                            </table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                            <div style="font-family:Inter, Helvetica, sans-serif;font-size:16px;line-height:160%;text-align:left;color:#000000;">
                                                                ...
                                                                <p>Please approve the plans below the MOQ on the MRP system with the following details...</p>
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                    <tr>
                                                                        <td>JOB Number &nbsp;: <b>'.$job_no.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Customer &nbsp;: <b>'.$cus_code.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>FG Code &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>'.$fg_code.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Descriptions &nbsp;: <b>'.$descriptions.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Plan Q`ty : <b>'.$plan_qty.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>MOQ &nbsp;&nbsp; : <b>'.$moq.'</b></td>
                                                                    </tr>
