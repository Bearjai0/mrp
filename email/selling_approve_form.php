<?php
    function HTMLForm($CFG, $user_code, $user_name, $fg_codeset, $cus_code, $owner_name, $package_type, $volume, $selling_price, $dwg_code, $margin, $due_date, $remarks){
        $dest = $CFG->path_main . $CFG->cost_selling . '/ini_selling_request';
        $html = '
            <!doctype html>
                                    ...
                                    <tr>
                                        ...
                                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                    <div style="font-family:Inter, Helvetica, sans-serif;font-size:32px;font-weight:600;line-height:140%;text-align:left;color:#000000;">Approval Selling Price.</div>
                                                </td>
                                                </tr>
                                            </tbody>
                                            </table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                            <div style="font-family:Inter, Helvetica, sans-serif;font-size:16px;line-height:160%;text-align:left;color:#000000;">
                                                                ...
                                                                <p>Please approve new Selling Price on the MRP system with the following details...</p>
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>Sell Price : <b>'.$selling_price.'</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Margin &nbsp;&nbsp; : <b>'.$margin.'</b></td>
                                                                    </tr>
                                                                    <tr>
