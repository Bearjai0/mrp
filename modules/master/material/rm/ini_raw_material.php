                    ...
                    try {
                        ...
                        var table = $(tbl, i = 0).DataTable({
                            ...
                            columns : [
                                ...
                                { data: function(data){
                                    return '<button onclick="OpenViewDetail(\'#load_view_detail\', \'load_rm_details\', \''+data.rm_code+'\')" class="btn btn-xs bg-gradient-blue fw-600 text-white"><i class="fa-solid fa-pencil"></i> Update</button>'
