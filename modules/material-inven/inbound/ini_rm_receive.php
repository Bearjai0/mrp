    ...
    <body>
        <div id="app" class="app app-header-fixed app-sidebar-fixed">
            ...
            <div id="content" class="app-content">
                <h1 class="page-header mb-3">Receive Raw Materials</h1>
                <div class="panel panel-inverse">
					<div class="panel-heading">
						<h4 class="panel-title">DataTable - Receive Raw Materials</h4>
            ...
            try {
                ...
                var table = $(tbl).DataTable({
                    ...
                    columns : [
                        ...
                        { data: function(data){
                            return '<button onclick="OpenViewDetail(\'#load_view_detail\', \'<?=$CFG->fol_material_inbound?>/load_rm_receive\', \''+data.po_no+'\')" class="btn badge rounded bg-gradient-green text-dark fw-700 me-2" data-toggle="modal"><i class="fa-solid fa-receipt"></i> Receive Materials</button>'+
                        ...
                        { data: function(data){ return '<span class="badge bg-gradient-blue">Pending</span>' }, className: "text-nowrap text-center" },
