    ...
    <body>
        <div id="app" class="app app-header-fixed app-sidebar-fixed">
            ...
            <div id="content" class="app-content">
                <h1 class="page-header mb-3">Planning List</h1>
                <div class="panel panel-inverse">
					<div class="panel-heading">
						<h4 class="panel-title">DataTable - Manage planning list</h4>
						<?php require_once("../../../comp_ui/panel-header.php"); ?>
					</div>
					<div class="panel-body">
                        <table id="table_planning_upload" class="table table-bordered" style="width: 100%;">
                            <thead>
                                <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        calldata('#table_planning_upload')
    })
