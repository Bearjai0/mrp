    ...
    <body>
        <div id="app" class="app app-header-fixed app-sidebar-fixed">
            ...
            <div id="content" class="app-content">
                <h1 class="page-header mb-3">Shipping details transactions</h1>
                <div class="panel panel-inverse">
					...
					<div class="panel-body">
                        ...
                        <hr>
                        <table id="table_shipping_details" class="table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap">Packing</th>
...
<script type="text/javascript">
    ...
    function calldata(tbl = '#table_shipping_details'){
        $.post('<?=$CFG->fol_rep_shipping?>/management', { protocol: 'ShippingDetails', start_date: $("#start_date").val(), end_date: $("#end_date").val() }, function(data){
            try {
                ...
                var table = $(tbl).DataTable({
                    ...
                    columns : [
                        ...
                        { data: function(data){ return data.job_plan_date == null ? '' : moment(data.job_plan_date).format('DD/MM/YYYY') }, className: "text-nowrap" },
                        { data: function(data){ return data.list_conf_type }, className: "text-nowrap" },
                        { data: function(data){ return data.conf_job_no }, className: "text-nowrap" },
                        ...
                        { data: function(data){ return data.conf_qty == null ? currency(data.list_receive_qty, { seperator: ',', symbol: '' }).format() : currency(data['conf_qty'], { seperator: ',', symbol: '' }).format() }, className: "text-nowrap text-right" },
                        { data: function(data){ return data.conf_packing_usage }, className: "text-nowrap text-right" },
                        { data: function(data){ return moment(data.list_conf_datetime).format('DD/MM/YYYY') }, className: "text-nowrap" },
                        { data: function(data){ return moment(data.list_conf_datetime).format('HH:mm') }, className: "text-nowrap" },
